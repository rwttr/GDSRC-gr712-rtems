...
rtems_libi2c_drv_t *intel_spi_flash_desc = &intel_spi_flash.libi2c_drv_entry;
...
*/
	...
	status = rtems_libi2c_register_drv("flash", intel_spi_flash_desc, 0, 1);
