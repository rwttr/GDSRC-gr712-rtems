...
//static char *tx_canname = "/dev/occan0";
//static char *rx_canname = "/dev/occan1";
...
rtems_task Init( rtems_task_argument ignored)
{
        ...
        printf("Init TASK: occanlib_open: Opening driver %s (init task)\n", OCCAN_DEVICE_RX_NAME);
/*
        int fd;
